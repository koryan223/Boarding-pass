-- Create get_student_analytics function
...
BEGIN
    ...
    -- Calculate remaining credits for the current week
    ...
    -- Calculate average swipes per week (for the selected month)
