-- Update get_student_analytics function to exclude re-entries from total counts
...
BEGIN
    ...
    -- Get total swipes this month, excluding re-entries by status
    ...
    -- Calculate remaining credits for the current week, excluding re-entries by status
    ...
    -- Get weekly data for the month, excluding re-entries by status
    ...
    -- Calculate average swipes per week (for the selected month), excluding re-entries by status
